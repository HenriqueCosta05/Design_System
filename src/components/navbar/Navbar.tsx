...
const Navbar = (Props: NavbarProps) => {
        ...
        return navItems.map((item, index) => (
            <li key={index} role="none" className="flex items-stretch">
                <a
                    ...
                    aria-haspopup="false"
                    className={`flex items-center gap-2 py-4 text-white transition-colors duration-300 hover:text-[var(--primary)] focus:text-[var(--primary)] focus:outline-none focus-visible:outline-none lg:px-8 ${
                        item.current ? "text-[var(--primary)]" : ""
                    }`}
                    href={item.href || "javascript:void(0)"}
                >
                    {type === 'cta-icons' && item.icon && (
                        <>{item.icon}</>
                    )}
    ...
    const renderLogo = () => (
        <a
            id="RoleSeeker"
            aria-label="RoleSeeker logo"
            aria-current="page"
            className="flex items-center gap-2 whitespace-nowrap py-3 text-lg focus:outline-none lg:flex-1 font-black text-white"
    ...
    switch (type) {
        case 'basic':
            return (
                <>
                    <header className="relative z-20 w-full border-b border-slate-200 bg-background shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        ...
        case 'cta':
            return (
                <>
                    <header className="relative z-20 w-full border-b shadow-lg border-slate-200 bg-background shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
                        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
                            <nav
                                aria-label="main navigation"
                                className="flex h-[5.5rem] items-stretch justify-between font-medium text-slate-700"
                            ...
                            >
                                ...
                                <div className="flex items-center px-6 ml-auto lg:ml-0 lg:p-0">
                                    <button className="inline-flex items-center justify-center h-10 gap-2 px-5 text-sm font-medium tracking-wide text-[var(--helperText)] transition duration-300 rounded shadow-md whitespace-nowrap bg-[var(--primary)] shadow-[var(--border)] hover:bg-[var(--border)] hover:shadow-sm hover:shadow-[var(--border)] focus:bg-[var(--border)] focus:shadow-sm focus:shadow-[var(--border)] focus-visible:outline-none disabled:cursor-not-allowed disabled:border-[var(--border)] disabled:bg-[var(--border)] disabled:shadow-none">
                        ...
                        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
                            ...
                            >
                                ...
                                <div className="ml-auto flex items-center px-6 lg:ml-0 lg:p-0">
                                    <button className="inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded bg-[var(--primary)] px-5 text-sm font-medium tracking-wide text-[var(--helperText)] shadow-md shadow-[var(--border)] transition duration-300 hover:bg-[var(--border)] hover:shadow-sm hover:shadow-[var(--border)] focus:bg-[var(--border)] focus:shadow-sm focus:shadow-[var(--border)] focus-visible:outline-none disabled:cursor-not-allowed disabled:border-[var(--border)] disabled:bg-[var(--border)] disabled:shadow-none">
                        ...
                        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
                            ...
                            >
                                ...
                                <div className="ml-auto flex items-center px-6 lg:ml-0 lg:p-0">
                                    <a
                                        href="#"
                                        className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-[var(--helperText)]"
                                    >
                                        <img
                                        ...
                                        />
                                        <span className="absolute bottom-0 right-0 inline-flex items-center justify-center gap-1 rounded-full border-2 border-white bg-pink-500 p-1 text-sm text-[var(--helperText)]">
            ...
            return (
                <>
                    <div className="border-b border-[var(--border)] bg-[var(--card)]">
                        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 px-6 py-2 text-sm text-[var(--text)] md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
                            <div className="col-span-2 items-center md:col-span-4 lg:col-span-6">
                                <a
                                    href="javascript:void(0)"
                                    className="flex items-center gap-2 transition-colors duration-300 hover:text-[var(--primary)]"
                                >
                                    <svg
                    ...
                    <header className="relative z-20 w-full border-b border-[var(--border)] bg-background shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-[var(--border)] lg:border-[var(--border)] lg:backdrop-blur-sm lg:after:hidden">
                        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
                            <nav
                                aria-label="main navigation"
                                className="flex h-[5.5rem] items-stretch justify-between font-medium text-[var(--text)]"
                                role="navigation"
                            >
                                {renderLogo()}
                                {renderToggleButton()}
                                ...
                                <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:p-0">
                                    <a
                                        href="#"
                                        className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-lg text-[var(--primary)]"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-5 w-5"
                                        ...
                                        <span className="absolute -right-1.5 -top-1.5 inline-flex items-center justify-center gap-1 rounded-full border-2 border-[var(--card)] bg-pink-500 px-1.5 text-sm text-[var(--helperText)]">
